export default {
  ...
  Shoppingcart: {
    ...
    Result: '範圍：-20.00D至+20.00D(如有小數，必須包含兩位小數，0.25D為一級)',
    Cornea: '範圍：36D至48D(如有小數，必須包含兩位小數，0.01D為一級)',
    LensDiameter: '範圍：8.80-11.50(如有小數，必須包含兩位小數，0.10mm為一級)'
  },
  Login: {
    doLogin: '登入',
    LoginTitle: '會員登入',
  ...
  DeliveryAddress: {
    ...
    AddressArea: '請選擇地區',
    Detail: '街道/屋苑/樓層/室',
    NoAddress: '暫無收貨地址，請添加',
    ChooseAddress: '請選擇收貨地址'
  },
  MyCoupon: {
    MyCoupon: '我的優惠券',
    Coupon: '優惠券',
  ...
  home: {
    ...
    DiscoverMore: '了解更多',
    ReadMore: '閱讀更多',
    Obtain: '只需輸入參數，DREIMLENS都可為您度身訂製合適您的隱形眼鏡',
    MoreText: 'DREIMLENS愛健視有限公司作為一所先進的透氣硬性隱形眼鏡工廠，為各地眼科及視光專業人士提供快捷優質的隱形眼鏡訂製服務。'
  },
  Action: {
    ReturnHomePage: '返回首頁',
    OrderDetails: '訂單詳情',
