export default {
  ...
  Shoppingcart: {
    ...
    Result: '范围：-20.00D至+20.00D(小数点必须包含两位小数，0.25D为一級)',
  ...
  home: {
    ...
    DiscoverMore: '了解更多',
    ReadMore: '阅读更多',
    Obtain: '只需输入参数，DREIMLENS都可为您度身订制合适您的隐形眼镜',
    MoreText: 'DREIMLENS爱健视有限公司作为一所先进的透气硬性隐形眼镜工厂，为各地眼科及视光专业人士提供快捷优质的隐形眼镜订制服务.'
  },
  Action: {
    ReturnHomePage: '返回首页',
    OrderDetails: '订单详情',
